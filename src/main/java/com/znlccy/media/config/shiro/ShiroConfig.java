package com.znlccy.media.config.shiro;
...
import com.znlccy.media.service.IResourceService;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.znlccy.media.entity.Resource> list = resourceService.findAll();
		for (com.znlccy.media.entity.Resource resource : list) {
