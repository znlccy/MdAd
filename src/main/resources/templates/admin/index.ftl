        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">媒体广告后台</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                    ...
                    <li>
                        <a class="J_menuItem" href="${ctx!}/admin/product/index">
                            <i class="fa fa-ban"></i>
                            <span class="nav-label">产品管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${ctx!}/admin/order/index">
                            <i class="fa fa-recycle"></i>
                            <span class="nav-label">订单管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${ctx!}/admin/advertise/index">
                            <i class="fa fa-key"></i>
                    ...
                    <li>
                        <a class="J_menuItem" href="${ctx!}/admin/machine/index">
                            <i class="fa fa-umbrella"></i>
                            <span class="nav-label">机台管理</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                        ...
                        <li>
                            <a class="J_menuItem" href="${ctx!}/admin/log/index">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                                <i class="fa fa-user"></i> <span class="label label-primary"></span>【<@shiro.principal type="com.znlccy.media.entity.User" property="nickName"/>】
                            </a>
                                ...
                                <li>
                                    <a onclick="updatePwd()">
                                        <div>
                                            ...
                                            <span class="pull-right text-muted small"><@shiro.principal type="com.znlccy.media.entity.User" property="userName"/></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
